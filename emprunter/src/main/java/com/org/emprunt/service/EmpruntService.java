...
import com.org.emprunt.kafka.EmpruntKafkaProducer;
...
public class EmpruntService {
    ...
    private final EmpruntKafkaProducer kafkaProducer;
    ...
    public Emprunter createEmprunt(Long userId, Long bookId) {
        ...
        kafkaProducer.sendEmpruntCreatedEvent(savedEmprunt.getId(), userId, bookId);
